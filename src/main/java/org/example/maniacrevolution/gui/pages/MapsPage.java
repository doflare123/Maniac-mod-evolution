...
public class MapsPage extends GuidePage {
    ...
    private void initMaps() {
        ...
        maps.add(new MapInfo(
                "Заброшенный город",
                "abandoned_city",
                "§7Классическая городская карта с множеством укрытий.",
                new String[]{
                        "§e● Особенности:",
                        "  - Высокие здания для вертикальной игры",
                        "  - Узкие улицы и переулки",
                        "  - Подземные канализации",
                        "  - Множество точек засады",
                        "",
                        "§e● Советы:",
                        "  §aВыжившим:§r Держитесь зданий, избегайте открытых площадей",
                        "  §cМаньякам:§r Используйте крыши для засад",
                        "",
                        "§e● Размер: §fСредний",
                        "§e● Сложность: §6★★★☆☆"
                }
        ...
        maps.add(new MapInfo(
                "Лесная чаща",
                "forest",
                "§7Густой лес с ограниченной видимостью.",
                new String[]{
                        "§e● Особенности:",
                        "  - Плотная растительность",
                        "  - Несколько полян для сражений",
                        "  - Пещеры и подземелья",
                        "  - Ограниченная видимость",
                        "",
                        "§e● Советы:",
                        "  §aВыжившим:§r Используйте деревья как укрытие",
                        "  §cМаньякам:§r Атакуйте из засады",
                        "",
                        "§e● Размер: §fБольшой",
                        "§e● Сложность: §6★★★★☆"
                }
    ...
    private void renderMapPreview(GuiGraphics gui, MapInfo map, int x, int y, int width, int height) {
        ResourceLocation texture = new ResourceLocation("maniacrev", "textures/maps/" + map.id + ".png");
