...
public class KeeperOfNightmaresClass extends CharacterClass {
    public KeeperOfNightmaresClass() {
        ...
        addItem("Кошмарная зажигалка", "Освещает пространство вокруг владельца в кошмарных испытаниях.");
        addItem("Игла пробуждения", "Выдаётся выжившим и запускает мини-игру для разрушения кокона.");
    }
}
