...
public class DeathClass extends CharacterClass {
    ...
    public DeathClass() {
        ...
        addFeature("Судный час", "[Активная КД 50] Может телепортироваться к случайному выжившему");
        addFeature("Смертельная гонка", "Каждое убийство усиливает урон на 2");

        // Предметы
        addItem("Коса смерти", "1 урон");
